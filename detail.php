...
$preference->external_reference = "mheme601@gmail.com";
...
$preference->back_urls = array(
    "success" => "https://moises-mp-ecommerce-php.herokuapp.com/success.php",
    "failure" => "https://moises-mp-ecommerce-php.herokuapp.com/failure.php",
    "rejected"=> "https://moises-mp-ecommerce-php.herokuapp.com/failure.php",
    "in_process" => "https://moises-mp-ecommerce-php.herokuapp.com/pending.php",
    "pending" => "https://moises-mp-ecommerce-php.herokuapp.com/pending.php"
);
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        ...
                                        <h3 >
                                            ...
                                            <?php //echo "http://localhost:8080/mp-ecommerce".$_POST['img'] ?>
                                        </h3>
                                        <h3 >
                                            <?php echo "$" . $_POST['unit'] ?>
                                        </h3>
                                    </div>
                                    <button type="submit" onclick="location.href='<?php echo $preference->init_point; ?>'" class="mercadopago-button" formmethod="post">Pagar la compra</button>
                                </div>
                            </div>
                        </div>
                    </div>
