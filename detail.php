...
$item->picture_url = "https://http2.mlstatic.com/resources/frontend/statics/growth-sellers-landings/device-mlb-point-i_medium@2x.png";
$item->quantity = 1;
...
$preference->back_urls = array(
    "success" => "http://lunatpruebas.site/success.php",
    "failure" => "http://lunatpruebas.site/failure.php",
    "rejected"=> "http://lunatpruebas.site/failure.php",
    "in_process" => "http://lunatpruebas.site/pending.php",
    "pending" => "http://lunatpruebas.site/pending.php"
);
